...
{ .spi_clksyn = SPI_SSL_MODE_CLK_SYN,
  ...
  .spck_div =
  {
  /* Actual calculated bitrate: 1000000. */.spbr = 11,
    .brdv = 0 },
...
const agt_extended_cfg_t g_agt1_extend =
...
const timer_cfg_t g_agt1_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 1 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x8000,
  .duty_cycle_counts = 0x4000, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = agt1_stats_callback,
...
/* Instance structure to use this module. */
const timer_instance_t g_agt1 =
{ .p_ctrl = &g_agt1_ctrl, .p_cfg = &g_agt1_cfg, .p_api = &g_timer_on_agt };
...
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xbb80,
  .duty_cycle_counts = 0x5dc0, .source_div = (timer_source_div_t) 0, .channel = 9, .p_callback = GPT9_CALLBACK,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .channel = 0, .rate = I2C_MASTER_RATE_STANDARD, .slave = 0x69, .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
...
const adc_channel_cfg_t g_adc0_channel_cfg =
        { .scan_mask = ADC_MASK_CHANNEL_0 | ADC_MASK_CHANNEL_1 | ADC_MASK_CHANNEL_2 | ADC_MASK_CHANNEL_5
                | ADC_MASK_CHANNEL_6 | ADC_MASK_CHANNEL_7 | ADC_MASK_CHANNEL_8 | ADC_MASK_CHANNEL_9
                | ADC_MASK_CHANNEL_10 | ADC_MASK_CHANNEL_19 | ADC_MASK_CHANNEL_20 | ADC_MASK_CHANNEL_21
                | ADC_MASK_CHANNEL_22 | 0,
